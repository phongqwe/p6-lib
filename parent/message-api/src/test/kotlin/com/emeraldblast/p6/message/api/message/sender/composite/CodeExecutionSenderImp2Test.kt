...
internal class CodeExecutionSenderImp2Test : TestOnJupyter() {
...
//    @Test
        ...
        runBlocking {
            val time = measureTimeMillis {
                ...
                for (x in 0 until msgCount) {
                    ...
                    val sender = CodeExecutionSenderImp2(
                        kernelContext = kernelContext,
                    )
    ...
    fun send_Ok() {
        runBlocking {
            val sender = CodeExecutionSenderImp2(kernelContext)
            val o = sender.send(message2)
...
//    @Test
    ...
    fun send_fail() {
        runBlocking {
            ...
            val sender = CodeExecutionSenderImp2(mockContext)
            val o = sender.send(message)

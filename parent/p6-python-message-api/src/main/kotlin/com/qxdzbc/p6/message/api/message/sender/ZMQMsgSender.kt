...
import com.qxdzbc.p6.message.api.connection.service.heart_beat.errors.HBServiceErrors
            ...
            if (hbs.isServiceUpAndHBLive()) {
                ...
                if (queueOk) {
                    ...
                    val report = ErrorReport(
                        header = SenderErrors.UnableToQueueZMsg.header,
                ...
                val report = ErrorReport(
                    header = HBServiceErrors.HBIsDead.header,
